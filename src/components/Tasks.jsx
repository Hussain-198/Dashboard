  ...
  return (
    <div className="w-full mt-10">
      <div className="flex justify-between items-center">
        ...
        <span className="text-sm font-extralight border border-zinc-200 rounded-2xl py-1 px-2 flex items-center gap-1 hover:cursor-pointer">
      ...
      <div className="flex flex-col gap-y-6 my-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-normal text-black">In progress</span>
          </div>
          <div className="flex items-center">
            ...
            <span className="text-sm font-normal text-black">4h</span>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-normal text-black">On hold</span>
          </div>
          <div className="flex items-center ml-5">
            <span className="flex items-center justify-center w-6 h-6 rounded-full bg-gray-400 mr-1 ">
              <FiClock size={24} className="text-white" />
            </span>
            <span className="text-sm font-normal text-black">8h</span>
          </div>
          <div className="hover:rounded-full hover:bg-zinc-200 px-1 py-1 hover:cursor-pointer">
            <FiMoreHorizontal size={18} className="text-black" />
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-normal text-black">Done</span>
          </div>
          <div className="flex items-center ml-11">
            <span className="flex items-center justify-center w-6 h-6 rounded-full bg-gray-400 mr-1">
              <FiClock size={24} className="text-white" />
            </span>
            <span className="text-sm font-normal text-black">32h</span>
          </div>
          <div className="hover:rounded-full hover:bg-zinc-200 px-1 py-1 hover:cursor-pointer">
            <FiMoreHorizontal size={18} className="text-black " />
          </div>
